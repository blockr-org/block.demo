$(() => {
  ...
  setTimeout(() => {
    ...
    sortable = new Sortable(draggable[0], {
      draggable: ".add-stack",
      onStart: () => {
      ...
      onEnd: (evt) => {
        ...
        const rowID = $(evt.originalEvent.srcElement)
          .closest(".masonry-row")
          .attr("id");
        const ns = $(evt.originalEvent.srcElement)
          .closest(".dash-page")
          .data("ns");
      ...
      .each((_, el) => {
        new Sortable(el, {
          ...
          onEnd: (evt) => {
            ...
            if (
              blockTypes.includes("plot_block") &&
              blockType == "plot_block"
            ) {
            ...
            const ns = $(target).closest(".dash-page").data("ns");
